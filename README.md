...
An automated web diagnostic tool built with Flask and Vercel that evaluates websites for AI search engine optimization (like GPTBot, Perplexity, and Google AI Overviews).
